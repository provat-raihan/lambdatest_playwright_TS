...
export class MyAccountPage {
  ...
  constructor(page: Page) {
    ...
    this.wishListPage = {
      ...
      productRemoveCartButton: page.locator(
        `css=div[id="content"] tbody tr a[data-original-title="Remove"]`
      ),
      emptyCartMessage: page.getByText('No results!'),
    };
  }
}
